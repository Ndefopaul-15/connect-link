...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('🎉 Welcome to Connect Link! Your account has been created successfully!', {
        duration: 5000,
        style: {
          background: '#10b981',
          color: '#fff',
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style={{ 
      ...
      <div className="max-w-md w-full space-y-8" style={{ position: 'relative', zIndex: 10 }}>
        <div className="text-center">
          ...
          <h1 className="mt-6 text-4xl font-bold text-white mb-2">Join Connect Link</h1>
